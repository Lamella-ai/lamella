...
2. Every successful entity create scaffolds the matching
   Schedule C/F/Personal expense tree as part of the create
   transaction. Scaffolding is unconditional — opting out is not
   supported because the next setup-recovery sweep would flag the
...
class TestAutoScaffoldOnCreate:
    def test_modal_create_writes_opens(
        ...
        assert any_scaffold, (
            ...
            "entity create; ledger before: " + ledger_before[:200]
        )
