...
def _import_all_steps() -> None:
    ...
    # step26 rebuilds user-defined tag→action workflow bindings from
    # custom "lamella-tag-binding" / "lamella-tag-binding-revoked"
    # directives in connector_config.bean (ADR-0065).
    import lamella.core.transform.steps.step26_tag_bindings  # noqa: F401
