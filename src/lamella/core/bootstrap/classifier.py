...
OWNED_CUSTOM_TARGETS: dict[str, str] = {
    ...
    # connector_links.bean (documents — formerly receipts; both
    # vocabularies recognized per ADR-0061. Writers emit document-*
    # only; readers accept either.)
    "document-link": "connector_links.bean",
    "document-link-hash-backfill": "connector_links.bean",
    "document-dismissed": "connector_links.bean",
    "document-dismissal-revoked": "connector_links.bean",
    "document-link-blocked": "connector_links.bean",
    "document-link-block-revoked": "connector_links.bean",
    # legacy v3 vocabulary — still recognized for import classification
    ...
    "receipt-link-blocked": "connector_links.bean",
    "receipt-link-block-revoked": "connector_links.bean",
    "paperless-doc-deleted": "connector_links.bean",
    ...
    # tag-workflow bindings (ADR-0065) — user-defined tag→action pairs
    # stored in connector_config.bean alongside other config state.
    "lamella-tag-binding": "connector_config.bean",
    "lamella-tag-binding-revoked": "connector_config.bean",
}
