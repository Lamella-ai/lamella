...
from lamella.web.routes import (
    ...
    receipts,
    receipts_needed as receipts_needed_route,
    ...
    txn_receipt as txn_receipt_route,
    dangling_receipts as dangling_receipts_route,
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app.include_router(receipts_needed_route.router)
    app.include_router(receipts.router)
    app.include_router(txn_receipt_route.router)
    app.include_router(dangling_receipts_route.router)
