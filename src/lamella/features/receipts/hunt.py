    ...
    *,
    ...
    raw_pass1 = conn.execute(
        ...
        SELECT pdi.paperless_id, pdi.vendor, pdi.receipt_date,
               ...
               pdi.created_date, pdi.document_type_name,
               CASE
        ...
        try:
            ...
            if fetched_live:
                ...
                pass2_filtered = [
                    ...
                    and not _doctype_excluded(r["document_type_name"])
                ]
                pass2_filtered.sort(
                    key=lambda r: (
                    ...
                    if ranked:
                        ...
                        if ranked_pids:
                            ...
                            excluded_set = {
                                ...
                                if _doctype_excluded(row["document_type_name"])
                            }
                            if excluded_set:
                                ranked = [
                                    r for r in ranked
