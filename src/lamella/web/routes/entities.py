...
def save_entity(
    ...
    # Always auto-scaffold canonical chart paths on save/create.
    # This keeps setup/recovery from reporting "missing chart"
    # immediately after an entity is added or edited. Idempotent:
    # AccountsWriter only opens missing paths.
    try:
